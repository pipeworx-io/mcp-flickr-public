...
`tools/list` at `https://gateway.pipeworx.io/flickr-public/mcp` returns the tools in the table
...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/flickr_public_recent \
  -H 'Content-Type: application/json' \
  -d '{"tags":"sunset,beach","tagmode":"all","limit":10}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/flickr_public_recent`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
